...
public class LegacyBluetoothLeScan {
    ...
    private LegacyLeDeviceListAdapter legacyLeDeviceListAdapter = new LegacyLeDeviceListAdapter();
    public LegacyLeDeviceListAdapter GetDeviceListAdapter()
    {
        return legacyLeDeviceListAdapter;
    }
    ...
    private ScanCallback leScanCallback =
            new ScanCallback() {
                ...
                public void onScanResult(int callbackType, ScanResult result) {
                    ...
                    legacyLeDeviceListAdapter.addDevice(result.getDevice());
